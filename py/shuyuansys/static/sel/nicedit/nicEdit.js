...
var nicUploadButton = nicEditorAdvancedButton.extend({	
	...
	addForm : function() {
		...
		myDoc.write('<div style="font-size: 14px; font-weight: bold; padding-top: 5px;">ÉÏ´«Í¼Æ¬</div>');
		myDoc.write('<input name="file" type="file" style="margin-top: 10px;" />');
		myDoc.write('<input type="submit" name="Submit" value="&#19978;&#20256;">');
		
		myDoc.write('</form>');
		//myDoc.write("<iframe name=ad frameborder=0 width=80% height=50 scrolling=no src=./nicedit/Upload.htm></iframe>");
	...
	startUpload : function() {
		...
		this.myStatus.setContent('<img src="./nicedit/loading.gif" style="float: right; margin-right: 40px;" /><strong>Uploading...</strong><br />Please wait');
		this.myForm.submit();
