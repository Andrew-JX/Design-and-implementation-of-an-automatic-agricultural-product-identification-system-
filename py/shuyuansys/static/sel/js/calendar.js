/*
 ...
 <div style="">开始时间:<input type="text" class=datetxt name="btime" id="btime"  onclick="SelectDate(this,'yyyy-MM-dd')"  this.Txt_Date.Attributes["onclick"] = "SelectDate(this,'yyyy-MM-dd')" />
 &nbsp;结束时间:<input type="text" class=datetxt name="etime" id="etime"  onclick="SelectDate(this,'yyyy-MM-dd')"  this.Txt_Date.Attributes["onclick"] = "SelectDate(this,'yyyy-MM-dd')" />&nbsp;<input type=button id="tongb" value="开始统计"  class="cupid-green" style="width:120px;" onclick="showlist(0);"></div>
