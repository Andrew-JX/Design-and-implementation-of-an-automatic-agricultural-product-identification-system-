...
var nicEditorConfig = bkClass.extend({
	...
	iconsPath : '/static/sel/nicedit/nicEditorIcons.gif',
...
var nicUploadButton = nicEditorAdvancedButton.extend({
	...
	addForm : function() {
		...
		myDoc.write('<form method="post" action="'+this.uri+'" enctype="multipart/form-data" name="sub_upload" target="_self">');
		//myDoc.write('<input type="hidden" name="APC_UPLOAD_PROGRESS" value="'+this.myID+'" />');
		if(this.uri == this.nicURI) {
			myDoc.write('<div style="position: absolute; margin-left: 160px;"><img src="#" width="30" style="float: left;" /><div style="float: left; margin-left: 5px; font-size: 10px;">Hosted by<br /><a href="#" target="_blank"></a></div></div>');
		}
		...
		myDoc.write('<input type="submit" name="Submit" value="&#19978;&#20256;">');

		myDoc.write('</form>');
		*/
		myDoc.write("<iframe name=ad frameborder=0 width=80% height=50 scrolling=no src=/upload/edit/Upload.jsp?f=picfc></iframe>");
		//myDoc.write("<span id=picfc></span>");
	...
	startUpload : function() {
		...
		this.myStatus.setContent('<img src="/static/sel/nicedit/loading.gif" style="float: right; margin-right: 40px;" /><strong>Uploading...</strong><br />Please wait');
		this.myForm.submit();
